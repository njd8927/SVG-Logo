...
describe('square', () => {
    it('should return code that creates a square', () => {
        ...
        const shape = userShape.render();
          // copy matching SVG syntax from render method in square class from shapes.js
        ...
        <text x="140" y="150" font-size="27" text-anchor="middle" fill="${this.textColor}">undefined</text>
        </svg>`);
    });
});
...
describe('circle', ()=> {
    it('should return code that creates a circle', () => {
        ...
        const shape = userShape.render();
        // copy matching SVG syntax from render method in circle class from shapes.js
        expect(shape).toEqual(`<svg version="1.1" width="300" height="200" xmlns="https://www.w3.org/TR/SVG/">
        <circle cx="75" cy="75" r="30" fill="${this.shapeColor}"/>
        <text x="75" y="80" font-size="27" text-anchor="middle" fill="${this.textColor}">undefined</text>
        </svg>`);
...
describe('triangle', () => {
    it('should return code that creates a triangle', () => {
        ...
        const shape = userShape.render();
          // copy matching SVG syntax from render method in triangle class from shapes.js
        expect(shape).toEqual(`<svg version="1.1" width="300" height="200" xmlns="https://www.w3.org/TR/SVG/">
        <polygon points="150,25 250,150 50,150" fill="${this.shapeColor}"/>
        <text x="145" y="100" font-size="27" text-anchor="middle" fill="${this.textColor}">undefined</text>
        </svg>`);
    });
});